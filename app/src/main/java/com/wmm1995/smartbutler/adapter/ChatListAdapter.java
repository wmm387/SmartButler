        ...
        if (convertView == null) {
            switch (type) {
                case VALUE_LEFT_TEXT:
                    ...
                    viewHolderLeftText.tv_left_text = (TextView) convertView.findViewById(R.id.tv_left_item);
                ...
                case VALUE_RIGHT_TEXT:
                    ...
                    viewHolderRightText.tv_right_text = (TextView) convertView.findViewById(R.id.tv_right_item);
